...
export class AgentSelectorService {
  ...
  private readonly PREFERRED_AGENT_STORAGE_KEY = 'blockus.preferredAgent';
  ...
  public async initialize() {
    ...
    this.statusbar.tooltip =
      'Set the preferred agent you want to use with blockus';
    this.statusbar.command = 'blockus.setAgent';
    this.updateStatusbarText('blockus agent');
    this.statusbar.show();
  ...
  public updateStatusbarText(text: string) {
    ...
    this.statusbar.text = `$(blockus-icon) ${text}`;
  }
